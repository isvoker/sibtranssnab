    ...
    public static function convertToAscii($str)
    {
        ...
        if (null === $utf8UpperAccents) {
            $utf8UpperAccents = [
                ...
                'Х'=>'H','Ц'=>'Ts','Ч'=>'CH','Ш'=>'Sh','Щ'=>'Shch','Ъ'=>'','Ы'=>'I','Ь'=>'','Э'=>'E','Ю'=>'Yu',
                'Я'=>'Ya','Ґ'=>'g','Є'=>'e','І'=>'i','Ї'=>'i','№'=>'no_'
            ];
        }
        ...
        // Дополнительный фильтр для спец символов
        $str = preg_replace(
            [
                '/[&]/', // амперсанды
                '/[\s]/', // пробелы
                '/[^a-z_\.\d-]/i', // все кроме допустимых символов (английский алфавит, цифры, тире, точка и нижнее подчеркивание)
            ],
            [
                'and',
                '_',
