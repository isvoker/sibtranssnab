...
$config['licenseKey'] = 'X133-X3XX-2XX3-X3XX-X2XX-3X3X-3XXC';
...
$config['backends'][] = [
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/files/incoming/',
//	'root'         => '', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => Cfg::CHMOD_FILES,
    'chmodFolders' => Cfg::CHMOD_FOLDERS,
...
$config['resourceTypes'][] = [
    ...
    'directory'         => 'images',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,ico,webp',
    'deniedExtensions'  => '',
    'backend'           => 'default'
];
